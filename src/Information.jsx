...
function Information() {
  ...
  return (
    <div className="min-h-screen flex flex-col text-1xl bg-gradient-to-bl from bg-red-400 to-blue-400">
      <h2 className="flex justify-center text-2xl mt-10"><strong>Smart Interviews - Transforming Careers</strong></h2>
      <br />
      <div className="px-10 mt-10">
      <p>
        <strong>Smart Interviews</strong> is one of the most sought-after 
        ...
        <br />
      <p>
        What makes Smart Interviews truly stand out is its 
      ...
      <p>
        ...
        <strong> personalized mentorship</strong>, Smart Interviews goes 
      ...
      <br />
      <p>
        With thousands of success stories already, Smart Interviews has 
