...
function Faculty() {
  ...
  return (
    <div className="min-h-screen flex flex-col text-1xl bg-gradient-to-bl from bg-red-400 to-blue-400">
      <h3 className=" flex flex-row justify-center mt-10"><strong className="text-2xl">Mr. Rishi Thakur Singh</strong> </h3>
      <div className="px-10 mt-10">
      <p>
        <strong>Mr. Rishi Thakur Singh</strong> is a highly acclaimed educator and one of the
      ...
      <p>
        Mr. Rishi Thakur Singh is not just a teacher — he is a mentor, a guide,
