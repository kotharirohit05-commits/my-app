...
function Bzbenefit() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-bl from bg-red-400 to-blue-400">
      <h2 className="flex justify-center text-2xl mt-10"><strong>How Being Zero Benefits You</strong></h2>
<br />
<div className="px-10 mt-10">
      <p>
        <strong>Being Zero</strong> is more than just a course — 
